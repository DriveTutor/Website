          ...
          <div className="dl-card">
            ...
            <div className="dl-btns">
              <a href="#" className="dl-btn dl-btn-white">
                <svg width="20" height="20" viewBox="0 0 814 1000" fill="currentColor"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 790.7 0 663 0 541.8c0-207.5 135.4-317.3 269-317.3 65 0 120 42.8 161.3 42.8 39.5 0 101.1-44.8 176.3-44.8 28.5 0 130.9 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z"/></svg>
                <div><div className="store-label-sm">Coming Soon</div><div>App Store</div></div>
              </a>
              <a href="#" className="dl-btn dl-btn-border">
                <svg width="20" height="20" viewBox="0 0 512 512" fill="currentColor"><path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l232.6-233-232.6-79zM0 35.3C0 15.8 11.7 0 25.3 0h.7L256 256 26 476.6H25c-13.7 0-25-15.8-25-35.4V35.3zM375.4 390L94.6 551.8l280.8-161.8 60.1 60.1zM376 120.4L94.6 280l60.1 60.1L376 120.4z" /><path d="M488 232.4L405.7 184 325.3 234.3l80.4 80.4L488 266.6c16.8-9.7 26-24.4 26-40.6s-9.2-30.9-26-33.6z"/></svg>
