...
export default function Page() {
  return (
    <PolicyLayout badge="🤝 Community" title="Community Guidelines" updated="January 1, 2025" toc={[]}>
      ...
      <section>
        <h2>Overview</h2>
        <p>This page contains Drive Tutor&apos;s Community Guidelines. Full policy content will be added here. Contact us at <a href="mailto:hello@drivetutor.ca">hello@drivetutor.ca</a> with any questions.</p>
      </section>
    </PolicyLayout>
  )
}
